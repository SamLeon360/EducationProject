...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    ...
    if (tableViewoffsetY < 125){
        ...
        [UIView animateWithDuration:0.25 animations:^{
            ...
            self.searchBar.frame = CGRectMake(-(self.viewWidth-60), 30, self.viewWidth-80, 30);
        ...
        [UIView animateWithDuration:0.25 animations:^{
            self.searchBar.frame = CGRectMake(20, 30, self.viewWidth-80, 30);
...
- (UISearchBar *)searchBar {
    if (!_searchBar) {
        _searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(-(self.viewWidth-60), 30, self.viewWidth-80, 30)];
...
- (UIButton *)emailButton {
    if (!_emailButton) {
        _emailButton = [[UIButton alloc] initWithFrame:CGRectMake(self.viewWidth-45, 30, 30, 30)];
